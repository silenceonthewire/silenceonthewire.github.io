...
<code>git clone https://github.com/silenceonthewire/com.silenceonthewire.esb.git</code>
<code>cd com.silenceonthewire.esb</code>
<ode>sbt run</code>
...
<code>curl -H "Content-Type: application/json" -X POST -d @W katalogu newCompany.json http://localhost:9000/api/v1/users/company/add</code>

<p>And we get the answer:</p>

<code>{"id": 1522759308539, "createdAt": 1522759308539, "updatedAt": 1522759308539, "name": "Example Company", "phone": "123456789", "taxNumber": "1234567890", "email": "company @ example.com "," address ":" street 1 "," city ":" city "," state ":" state "," country ":" country "," postalCode ":" 11-111 "," users "[]}</code>
...
<code>curl -H "Content-Type: application/json" -X PUT -d @currentCompany.json http://localhost:9000/api/v1/users/company/update</code>

<p>And we get the answer:</p>

<code>{"id":1522759308539,"createdAt":1522759308539,"updatedAt":1522760348933,"name":"Example Company","phone":"123456789","taxNumber":"1234567890","email":"company@example.com","address":"street 1","city":"city","state":"state","country":"country","postalCode":"11-111","users":[]}</code>

<h4>Delete company</h4>

<p>To delete company we send the following request:</p>

<code> curl -H "Content-Type: application/json" -X DELETE http://localhost:9000/api/v1/users/company/delete/1522759308539</code>
...
<code>curl http://localhost:9000/api/v1/users/company/getById/1522760698755</code>
...
<code>curl http://localhost:9000/api/v1/users/company/getByTaxNumber/1234567890</code>
...
<code>curl http://localhost:9000/api/v1/users/company/getByEmail/company@example.com</code>
...
<code> curl http://localhost:9000/api/v1/users/company/getByPhone/123456789</code>

<p>if the request succeeds, the system will be returned:</p>

<code>{"id":1522761344385,"createdAt":1522761344385,"updatedAt":1522761344385,"name":"ExampleCompany","phone":"123456789","taxNumber":"1234567890","email":"company@example.com","address":"street 1","city":"city","state":"state","country":"country","postalCode":"11-111","users":[]}</code>

<h4>Get all companies</h4>

<p>To get all companies, send the following request:</p>

<code> curl http://localhost:9000/api/v1/users/company/all</code>
...
<h4>Create new user</p>

<p>If you can add user, send the following request:</p>

<code>curl -H "Content-Type: application/json" -X POST -d @newUser.json http://localhost:9000/api/v1/users/user/add</code>

<p>if the request succeeds, the system will be returned:</p>

<code>{"id":1522772875674,"createdAt":1522772875674,"updatedAt":1522772875674,"firstName":"jonh","lastName":"Doe","email":"john1@doe.com","phone":"12345167689","isAdmin":true,"admin":true},{"id":1522772977796,"createdAt":1522772977796,"updatedAt":1522772977796,"firstName":"jonh","lastName":"Doe","email":"john@doe.com","phone":"1235167689","isAdmin":true,"admin":true}</code>

<h4>Update user</h4>

<p>If you can update user, send the following request:</p>

<code> curl -H "Content-Type: application/json" -X PUT -d @currentUser.json http://localhost:9000/api/v1/users/user/edit/1522772875674</code>

<p>And if the request succeeds, the system will be returned:</p>

<code>{"id":1522772875674,"createdAt":1522772875674,"updatedAt":1522773478050,"firstName":"jonh","lastName":"Doe","email":"john322343@doe.com","phone":"12334325167689","isAdmin":true,"admin":true}</code>

<h4>Get user by id</h4>

<p>If you can get user by id, you must send this request:</p>

<code>curl http://localhost:9000/api/v1/users/user/getById/1522772875674</code>
...
<code>curl http://localhost:9000/api/v1/users/user/getByPhone/12334325167689</code>
...
<code>curl http://localhost:9000/api/v1/users/user/getByEmail/john322343@doe.com</code>
...
<code>http://localhost:9000/api/v1/users/user/all</code>
...
<code>curl -H "Content-Type: application/json" -X POST -d @phoneAndPassword.json http://localhost:9000/api/v1/users/user/getByPhoneAndPassword</code>

<p>And if the request succeeds, the system will be returned:</p>

<code>{"id":1522776276728,"createdAt":1522776276728,"updatedAt":1522776276728,"firstName":"jonh","lastName":"Doe","email":"john@doe.com","phone":"1235167689","isAdmin":true,"admin":true}</code>

<h4>Get user by email and password</h4>

<p>If you can get user by email and password, you must send this request:</p>

<code>curl -H "Content-Type: application/json" -X POST -d @emailAndPassword.json http://localhost:9000/api/v1/users/user/getByEmailAndPassword</code>
...
<code>curl -H "Content-Type: application/json" -X DELETE http://localhost:9000/api/v1/users/user/delete/1522776276728</code>
...
<code>curl -H "Content-Type: application/json" -X POST -d @newAccount.json http://localhost:9000/api/v1/users/account/create</code>

<p>And if the request succeeds, the system will be returned:</p>

<code>{"id":1522783057798,"createdAt":1522783057798,"updatedAt":1522783057798,"user":null,"taxNumber":"21434","ssn":"43546547","address":"Street 1","city":"city","state":"state","country":"country","postalCode":"23334"}</code>

<h4>Get by id.</h4>

<p>If you can get account by id, you must send this request:</p>

<code>curl http://localhost:9000/api/v1/users/account/byTaxNumber/21434</code>
...
<code>curl http://localhost:9000/api/v1/users/account/bySsn/43546547</code>
...
<code>curl -H "Content-Type: application/json" -X PUT -d @currentAccount.json http://localhost:9000/api/v1/users/account/update</code>

<p>And if the request succeeds, the system will be returned:</p>

<code>{"id":1522783057798,"createdAt":1522783057798,"updatedAt":1522786151443,"user":{"id":1522782031521,"createdAt":1522782031521,"updatedAt":1522782031521,"firstName":"jonh","lastName":"Doe","email":"john@doe.com","phone":"1235167689","isAdmin":true,"admin":true},"taxNumber":"df21434","ssn":"435465rte47","address":"Street 1","city":"city","state":"state","country":"country","postalCode":"23334"}</code>
